...
A real-time EMG (electromyography) classification system that detects hand and wrist movements using an OpenBCI Cyton board, classifies them with a 1D CNN, and drives VR arm animations in Unity
